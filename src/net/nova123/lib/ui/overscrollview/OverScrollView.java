package net.nova123.lib.ui.overscrollview;
...
public class OverScrollView extends FrameLayout implements OnTouchListener {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		System.out.println("on touch  View.....");
		...
		switch (action & MotionEvent.ACTION_MASK) {
		case MotionEvent.ACTION_DOWN: {
			System.out.println("on touch  ACTION_DOWN.....");
		...
		case MotionEvent.ACTION_MOVE:
			System.out.println("on touch  ACTION_MOVE.....");
			if (mIsBeingDragged) {
			...
			break;
		case MotionEvent.ACTION_UP:
			System.out.println("on touch  ACTION_UP.....");
			if (mIsBeingDragged) {
			...
			break;
		case MotionEvent.ACTION_CANCEL:
			System.out.println("on touch  ACTION_CANCEL.....");
