...
public class WheelView extends View {
	...
	public WheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		TypedArray params = context.obtainStyledAttributes(attrs, R.styleable.WheelView);
		backgroudId = params.getResourceId(R.styleable.WheelView_imgBackground, 0);
		initData(context);
	}
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_val_pic);
		}
